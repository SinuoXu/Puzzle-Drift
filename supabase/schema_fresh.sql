-- Fresh install for Puzzle Drift v0.2.
-- Run this only on a new Supabase project.
...
create table if not exists public.app_users (
  ...
  constraint app_users_username_length check (char_length(btrim(username)) between 1 and 24)
);
